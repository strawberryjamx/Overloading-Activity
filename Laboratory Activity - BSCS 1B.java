public class App {
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        System.out.println("The sum of 20 and 50 is " + App.computeSum(20,
                50));
        System.out.println("The sum of 20 and 45 and 80 is " +
                App.computeSum(20, 45, 80));
        System.out.println("\n==================\n");
        /**
         * Call the greaterValue method with integer parameters
         */
        System.out.println("The greater integer value between 45 and 100 is "
                + greaterValue(45,100));
        /**
         * Call the greaterValue method with double parameters
         */
        System.out.println("The greater double value between 3.14 and 9.8 is "
                + greaterValue(3.14,9.8));
    }
}